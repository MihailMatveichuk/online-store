...
const OrderForm = ({toggle}:IToggle) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      name: Yup.string()
              .matches(/([A-Za-zА-Яа-яЁё]{3,}\W[A-Za-zА-Яа-яЁё]{3,})$/gm, "This field involved First and Second name" )
      ...
      cardData: Yup.string()
              .matches(/^(0?[1-9]|1[012])\/([2-9]|1[012]){2}$/, "Invalid card valid")
  ...
  return (
      <FormStyle onSubmit={formik.handleSubmit}>
          ...
          <input
              ...
              onBlur={formik.handleBlur}
          />
          {formik.errors.numberOfCard && formik.touched.numberOfCard ? <div className='error'>{formik.errors.numberOfCard}</div>: null}
            <div className='card-data'>
                <div>
                    ...
                    onBlur={formik.handleBlur}
                />
                {formik.errors.cardData && formik.touched.cardData ? <div className='error'>{formik.errors.cardData}</div>: null}
                </div>
                <div>
                    ...
                    onBlur={formik.handleBlur}
                />
                {formik.errors.cardCvv && formik.touched.cardCvv ? <div className='error'>{formik.errors.cardCvv}</div>: null}
            </div>
            </div>
          </div>
